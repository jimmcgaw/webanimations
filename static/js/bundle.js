...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Throbber = __webpack_require__(168);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Throbber2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Throbber = function (_Component) {
	  _inherits(Throbber, _Component);

	  function Throbber() {
	    _classCallCheck(this, Throbber);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Throbber).apply(this, arguments));
	  }

	  _createClass(Throbber, [{
	    ...
	    value: function animateLoadingDots() {
	      var keyframes = [{ 'transform': 'scale(0.7)' }, { 'transform': 'scale(1.0)' }, { 'transform': 'scale(0.7)' }];
	      ...
	      var firstDot = _reactDom2.default.findDOMNode(this.refs.firstDot);
	      firstDot.animate(keyframes, properties);

	      properties['delay'] = 200;

	      var secondDot = _reactDom2.default.findDOMNode(this.refs.secondDot);
	      secondDot.animate(keyframes, properties);

	      properties['delay'] = 400;

	      var thirdDot = _reactDom2.default.findDOMNode(this.refs.thirdDot);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'throbber', title: 'Your content is loading...' },
	        _react2.default.createElement('div', { className: 'dot', ref: 'firstDot' }),
	        _react2.default.createElement('div', { className: 'dot', ref: 'secondDot' }),
	        _react2.default.createElement('div', { className: 'dot', ref: 'thirdDot' })
	      );
	    }
	  }]);
